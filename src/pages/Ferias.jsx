...
export default function Ferias() {
  ...
  function handleCalcular(e) {
    ...
    // Para férias gozadas, se proporcionais < salário, usar proporcionais como base
        ...
        <div id="resultado" className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-2xl p-6 text-center">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Exporte em PDF profissional com todos os detalhes para apresentar ao seu empregador ou contador.
            </p>
            <Link
              to="/premium"
