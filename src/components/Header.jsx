    ...
    <header className="bg-[#1a1a2e] border-b border-[#16213e] sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link
            to="/premium"
            className="hidden lg:inline-flex items-center gap-1.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white text-sm font-semibold px-4 py-2 rounded-lg shadow-lg shadow-amber-500/20 hover:shadow-amber-500/40 transition-all duration-200"
          >
